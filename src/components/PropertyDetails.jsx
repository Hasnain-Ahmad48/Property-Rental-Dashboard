import { HiX, HiStar, HiLocationMarker, HiUsers, HiHeart, HiOutlineHeart } from 'react-icons/hi';
        ...
        <div className="fixed inset-0 z-50 flex items-center justify-center p-4 animate-fade-in">
            ...
            <div className="relative bg-white dark:bg-gray-800 rounded-3xl max-w-4xl w-full max-h-[90vh] overflow-y-auto shadow-2xl animate-scale-in">
                ...
                <div className="relative h-80 overflow-hidden rounded-t-3xl">
                    ...
                    />
                    <div className="absolute bottom-4 left-4 px-4 py-2 bg-primary-500 text-white rounded-xl text-sm font-medium shadow-lg">
                        {property.type}
                    </div>
                </div>
